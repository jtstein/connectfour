...
; If compiling on windows, pathing may need to be edited.
;(define exe-1 "C:\\Program Files\\Racket\\Racket.exe")
;(define args-1 "connect-four-naive.rkt")
;(define exe-2 "C:\\Python27\\python.exe")
;(define args-2 "connectfour.py")

; Works for my Ubuntu Linux Python VS Doug's Racket Naive Program
;(define exe-1 "/usr/bin/racket")
;(define args-1 "connect-four-naive.rkt")
;(define exe-2 "/usr/bin/python2.7")
;(define args-2 "connectfour.py")

; Works for my Ubuntu Linux Python VS itself
;(define exe-1 "/usr/bin/python2.7")
;(define args-1 "connectfour.py")
;(define exe-2 "/usr/bin/python2.7")
;(define args-2 "connectfour.py")

; Works for my Ubuntu Linux Python VS Lewi's Python program
;(define exe-1 "/usr/bin/python2.7")
;(define args-1 "connect-four-AI.py")
;(define exe-2 "/usr/bin/python2.7")
;(define args-2 "connectfour.py")

; Works for my Ubuntu Linux Python VS Jonathan's Python program
(define exe-1 "/usr/bin/python2.7")
(define args-1 "connectfour.py")
(define exe-2 "/usr/bin/python3.4")
(define args-2 "connect-four.py")



; LINUX PYTHON against ANDREW JAVA
;(define exe-1 "/usr/share/java")
;(define args-1 "/home/jordan/connectfour/runme.jar")
;(define exe-2 "/usr/bin/python2.7")
;(define args-2 "connectfour.py")
...
(define (play (first-player (if (<= (random) 0.5) 1 2)) (print-game? #t))
  ...
  ; PYTHON VS JAVA
 ; (define-values (process-1 process-stdout-1 process-stdin-1 process-stderr-1)
 ;   (subprocess #f #f stderr-1 exe-1 "-jar" args-1))
 ; (define-values (process-2 process-stdout-2 process-stdin-2 process-stderr-2)
 ;   (subprocess #f #f stderr-2 exe-2  args-2))
...
; play to play once
(play)
;(head-to-head) to play many times
